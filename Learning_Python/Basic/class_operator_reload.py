# -*- coding:utf-8 -*-
###
# File: class_operator_reload.py
# Created Date: 2020-04-21
# Author: anddy.liu
# Contact: <lqdflying@gmail.com>
# 
# Last Modified: Thursday April 23rd 2020 10:29:29 pm
# 
...
class Vector:
   ...
   def __add__(self,new):
      return "it's just a test:%s||%s||%s||%s"%(self.a, new.a, self.b, new.b)
v1 = Vector(2,10)
v2 = Vector(5,-2)
print (v1 + v2)
